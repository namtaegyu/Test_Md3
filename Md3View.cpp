...
BEGIN_MESSAGE_MAP(CMd3View, CView)
	...
	ON_COMMAND(ID_FONT_1, &CMd3View::OnFont1)
	ON_COMMAND(ID_FONT_8, &CMd3View::OnFont8)
	ON_COMMAND(ID_FONT_16, &CMd3View::OnFont16)
END_MESSAGE_MAP()
